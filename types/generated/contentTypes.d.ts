...
export interface ApiCollezioneCollezione extends Struct.CollectionTypeSchema {
  collectionName: 'collezioni';
  info: {
    displayName: 'Collezione';
    pluralName: 'collezioni';
    singularName: 'collezione';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    immagine_hero: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::collezione.collezione'
    > &
      Schema.Attribute.Private;
    nome: Schema.Attribute.String;
    prodotti: Schema.Attribute.Relation<'oneToMany', 'api::prodotto.prodotto'>;
...
export interface ApiProdottoProdotto extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    categoria: Schema.Attribute.Relation<
      ...
      'api::categoria.categoria'
    >;
    collezione: Schema.Attribute.Relation<
      'manyToOne',
      'api::collezione.collezione'
    >;
    createdAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::collezione.collezione': ApiCollezioneCollezione;
